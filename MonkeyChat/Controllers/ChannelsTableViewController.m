...
@interface ChannelsTableViewController () <NSFetchedResultsControllerDelegate>
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"ServerChannel" inManagedObjectContext:self.managedObjectContext];
      ...
      newIndexPath:(NSIndexPath *)newIndexPath
{
    ...
    switch(type) {
        ...
        case NSFetchedResultsChangeUpdate:
            [self configureCell:(ChannelCell *)[tableView cellForRowAtIndexPath:indexPath] atIndexPath:indexPath];
            break;
