...
{
    DLog(@"onPrivmsg, message: %@, nick: %@",  [[NSString alloc] initWithData:message
                                                                     encoding:NSUTF8StringEncoding], nick);
...
{
    DLog(@"onNotice, notice: %@, nick: %@",  [[NSString alloc] initWithData:notice
                                                                   encoding:NSUTF8StringEncoding], nick);
